...
desmpi_wrapper.mod : ./des/mpi_donothing/desmpi_wrapper_mod.f \
            parallel_mpi.mod \
            mpi_utility.mod \
            compar.mod 
	$(FORTRAN_CMD) $(FORT_FLAGS) ./des/mpi_donothing/desmpi_wrapper_mod.f 
...
compar.mod : ./dmp_modules/mpi_donothing/compar_mod.f \
            mpi.mod 
	$(FORTRAN_CMD) $(FORT_FLAGS) ./dmp_modules/mpi_donothing/compar_mod.f 
dbg_util.mod : ./dmp_modules/mpi_donothing/dbg_util_mod.f \
            compar.mod \
            geometry.mod \
            parallel_mpi.mod \
            indices.mod \
            function.inc                                                
	$(FORTRAN_CMD) $(FORT_FLAGS) ./dmp_modules/mpi_donothing/dbg_util_mod.f 
debug.mod : ./dmp_modules/mpi_donothing/debug_mod.f \
            funits.mod 
	$(FORTRAN_CMD) $(FORT_FLAGS) ./dmp_modules/mpi_donothing/debug_mod.f 
gridmap.mod : ./dmp_modules/mpi_donothing/gridmap_mod.f \
            mpi_utility.mod \
            parallel_mpi.mod \
            geometry.mod \
            sendrecv.mod \
            ...
            indices.mod \
            function.inc                                                
	$(FORTRAN_CMD) $(FORT_FLAGS) ./dmp_modules/mpi_donothing/gridmap_mod.f 
mpi.mod : ./dmp_modules/mpi_donothing/mpi_mod.f \
            mpif.h                                                      
	$(FORTRAN_CMD) $(FORT_FLAGS) ./dmp_modules/mpi_donothing/mpi_mod.f 
mpi_utility.mod : ./dmp_modules/mpi_donothing/mpi_utility_mod.f \
            geometry.mod \
            compar.mod \
            parallel_mpi.mod \
            debug.mod \
            ...
            funits.mod \
            function.inc                                                
	$(FORTRAN_CMD) $(FORT_FLAGS) ./dmp_modules/mpi_donothing/mpi_utility_mod.f 
parallel_mpi.mod : ./dmp_modules/mpi_donothing/parallel_mpi_mod.f \
            geometry.mod \
            compar.mod 
	$(FORTRAN_CMD) $(FORT_FLAGS) ./dmp_modules/mpi_donothing/parallel_mpi_mod.f 
sendrecv3.mod : ./dmp_modules/mpi_donothing/sendrecv3_mod.f \
            parallel_mpi.mod \
            debug.mod \
            geometry.mod \
            compar.mod \
            ...
            mpi.mod \
            function.inc                                                
	$(FORTRAN_CMD) $(FORT_FLAGS) ./dmp_modules/mpi_donothing/sendrecv3_mod.f 
sendrecv.mod : ./dmp_modules/mpi_donothing/sendrecv_mod.f \
            parallel_mpi.mod \
            debug.mod \
            geometry.mod \
            compar.mod \
            ...
            mpi.mod \
            function.inc                                                
	$(FORTRAN_CMD) $(FORT_FLAGS) ./dmp_modules/mpi_donothing/sendrecv_mod.f 
